...
export default function AdminDashboard() {
  ...
  const upcomingReservations =
    reservations?.filter((res) => {
      const resDate = new Date(res.date);
      return (
        isAfter(resDate, today) &&
        isAfter(resDate, startOfDay(addDays(today, 7)))
      );
    }) || [];
                    ...
                    <div className="space-y-4">
                      {todayReservations
                        ...
                        .map((reservation) => (
                          <div
                            key={reservation.id}
                            className="flex items-start p-3 rounded-md bg-neutral-50 hover:bg-neutral-100"
                          >
              ...
              <CardContent className="space-y-4">
                ...
                <div className="p-4 bg-secondary/10 rounded-md">
                  ...
                  <p className="text-sm text-neutral-600 mb-4">
                    If you need assistance with the admin panel, check out the
